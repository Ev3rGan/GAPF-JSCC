...
- [论文撰写现行规范](../paper/论文撰写现行规范.md)
- [最终成稿验收标准](../paper/论文成稿验收标准.md)
- [公式与符号审计表](../paper/公式与符号审计表.md)

这三份材料分别记录跨模块写作约束、最终成稿门槛以及 V4 数学对象的统一语义。它们用于解释论文如何保持问题、方法、公式和证据的一致性；逐轮访谈、修改日志和工作论文源文件不在公开范围内。
